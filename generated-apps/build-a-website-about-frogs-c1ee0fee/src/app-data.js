export default {
  "name": "build-a-website-about-frogs",
  "category": "Web App",
  "theme": {
    "accent": "#0f8b8d",
    "ink": "#102027",
  ...
  "pages": [
    {
      "id": "overview",
      "label": "Overview",
      "headline": "a about frogs",
      "summary": "A working web app experience generated from your request, focused on build, website, about, frogs.",
      "features": [
        "Live product shell",
