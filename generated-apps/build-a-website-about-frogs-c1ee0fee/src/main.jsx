...
function App() {
  return (
    <main className="page">
      <nav className="nav"><strong>build-a-website-about-frogs</strong><a>Features</a><a>Pricing</a><button>Start Building</button></nav>
      <section className="hero">
        <p className="eyebrow">NexusBrowser generated starter</p>
        <h1>build a website about frogs</h1>
